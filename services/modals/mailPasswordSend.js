                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-table-lspace: 0pt !important;mso-table-rspace: 0pt !important;border-spacing: 0 !important;border-collapse: collapse !important;table-layout: fixed !important;margin: 0 auto !important;">
                    ...
                    <tr style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                      <td class="bg_white email-section" style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background: #ffffff;padding: 0em;mso-table-lspace: 0pt !important;mso-table-rspace: 0pt !important;">
                        ...
                        <span class="subheading" style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;display: inline-block;font-size: 13px;text-transform: uppercase;letter-spacing: 2px;color: rgba(0,0,0,.4);position: relative; !important;">Şifre Sıfırlama</span>
                        <hr width="100%" color="#a88132" size="4">
                        <p style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">Sevgili Kullanıcımız,</p>
                    <p style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">Bu eposta, yeni şifrenizi size ulaştırmak için size otomatik olarak Tikmoney tarafından gönderilmiştir..</p>
                    <p style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">Şifre işleminiz başarılı bir şekilde gerçekleşmiştir aşağıda belirtilen şifre yeni şifreniz olarak atanmıştır. Lütfen yeni şifrenizi kimse ile payşamayınız.</p>
